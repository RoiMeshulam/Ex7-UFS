...
//    printf("fd2: %d\n",dir2->dirp);
////    char buf[100];
    int myfd = myopen("/root/roi/third",0);
    int myfd1 = myopen("/root/roi/second",3);
    int myfd2 = myopen("/root/roi/second",2);
    int myfd3 = myopen("/root/roi/five",4);
    int myfd4 = myopen("/root/roi/second",4);
